	...
	return (
		...
		>
			<div className='space-y-4'>
				<div>
					<label htmlFor='voucher' className='mb-2 block text-sm font-medium text-gray-300'>
						আপনার কি কোপন বা গিফট কার্ড আছে? 
					</label>
					<input
						type='text'
						id='voucher'
			...
			{isCouponApplied && coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-gray-300'>এপ্লাইড কোপন </h3>

					<p className='mt-2 text-sm text-gray-400'>
						{coupon.code} - {coupon.discountPercentage}% ছাড়
					</p>
			...
			{coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-gray-300'>আপনার কোপন সমূহ :</h3>
					<p className='mt-2 text-sm text-gray-400'>
						{coupon.code} - {coupon.discountPercentage}% ছাড়
					</p>
				</div>
